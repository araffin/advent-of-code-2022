...
fn check_overlap(low1: u32, high1: u32, low2: u32, high2: u32) -> bool {
    // Check if there the two intervals are disjoint
    // and negate the result
    !(high1 < low2 || high2 < low1)
}
...
fn part2() {
    ...
    for line in input.lines() {
        ...
        total += check_overlap(low1, high1, low2, high2) as u32;
    }
    // Print the total
    println!("{}", total);
}
